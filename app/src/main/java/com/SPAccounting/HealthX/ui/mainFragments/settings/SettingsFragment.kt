...
import com.SPAccounting.HealthX.databinding.BottomsheetModalBinding
...
import com.SPAccounting.HealthX.databinding.FragmentSettingsBinding
...
//                        findNavController().navigate(R.id.action_settings_to_profileFragment)
    ...
    private fun aboutUs() {
        ...
        aboutUsDialog.apply {
            paragraphHeading.text = getString(R.string.welcome_to_HealthX)
